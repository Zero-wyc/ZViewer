/**
 * 播放器原版 SVG 图标集（Hydrogen Player.vue / MusicWidget.vue 的 path 原样移植）。
 *
 * 与 lucide 近似版的差异：三键控制为「线条式」（< 形箭头 + 描边三角 +
 * 双竖线，stroke 8/200 viewBox）；song-control 的歌词类型切换（罗马音 A /
 * 翻译 译字 / 原词 方框T）、喜欢（描边心 ↔ 红心实心 #E5404F）、播放模式
...
/** 下一首（> 形线条箭头，viewBox 200） */
export function ControlNextIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 200 200" className={className} aria-hidden="true">
      <path
        d="M133.56,105.98L66.78,0L0,106 "
...
/** 播放（描边三角 ▷，viewBox 200） */
export function ControlPlayIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 200 200" className={className} aria-hidden="true">
      <path
...
/** 暂停（双竖线，viewBox 200） */
export function ControlPauseIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 200 200" className={className} aria-hidden="true">
      <path
        d="M0,0L0,152 "
...
/** 罗马音切换图标（Hydrogen t=1673182533775 / p-id 47744 原版 path） */
export function RomanLyricIcon({ className }: { className?: string }) {
  return (
    <svg
...
export function OriginalLyricIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M934.4 1024h-844.8c-49.152 0-89.6-40.448-89.6-89.6v-844.8c0-49.152 40.448-89.6 89.6-89.6h844.8c49.152 0 89.6 40.448 89.6 89.6v844.8c0 49.152-40.448 89.6-89.6 89.6z m-844.8-957.44c-12.8 0-23.04 10.24-23.04 23.04v844.8c0 12.8 10.24 23.04 23.04 23.04h844.8c12.8 0 23.04-10.24 23.04-23.04v-844.8c0-12.8-10.24-23.04-23.04-23.04h-844.8z" />
      <path d="M803.84 283.648h-583.68c-18.432 0-33.28-14.848-33.28-33.28s14.848-33.28 33.28-33.28h583.68c18.432 0 33.28 14.848 33.28 33.28s-14.848 33.28-33.28 33.28z" />
      <path d="M478.72 835.072v-583.68c0-18.432 14.848-33.28 33.28-33.28s33.28 14.848 33.28 33.28v583.68c0 18.432-14.848 33.28-33.28 33.28s-33.28-14.848-33.28-33.28z" />
    </svg>
  )
}

/** 歌词模糊切换图标（水滴造型，呼应「雾化/模糊」意象；fill currentColor 随开关着色） */
export function LyricBlurIcon({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 1024 1024"
      className={className}
      ...
      aria-hidden="true"
    >
      <path d="M512 96C460 208 224 464 224 656a288 288 0 0 0 576 0C800 464 564 208 512 96Z" />
    </svg>
  )
}

/** 喜欢描边心（Hydrogen t=1668786418014 / p-id 1417 原版 path） */
export function LikeOutlineIcon({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 1024 1024"
      className={className}
...
/** 喜欢红心实心（Hydrogen t=1668786896650 / p-id 9976 原版 path，#E5404F） */
export function LikeFilledIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 1025 1024" className={className} aria-hidden="true">
      <path
...
/** 播放模式：按顺序播放（不循环——列表行 + 箭头指向末尾竖线；
 *  B站 推荐连播仅在此模式启用） */
export function ModeOrderIcon({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
...
/** 播放模式：顺序循环（Hydrogen t=1670376314067 / p-id 3090 原版 path） */
export function ModeSequenceIcon({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 1024 1024"
      className={className}
...
/** 播放模式：单曲循环（Hydrogen t=1668787191526 / p-id 2501 原版 path，带数字 1） */
export function ModeRepeatOneIcon({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 1024 1024"
      className={className}
    ...
    >
      ...
      <path d="M544 672V352h-48L416 409.6l16 41.6 60.8-41.6V672z" />
    </svg>
  )
}

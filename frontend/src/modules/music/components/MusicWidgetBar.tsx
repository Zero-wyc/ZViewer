...
export function MusicWidgetBar() {
  ...
  return (
    ...
    >
      ...
      {/* 定位（Hydrogen .music-progress-container 方案）：容器贴卡片顶边
          top-0，内层条 translateY(-50%) 骑在边缘上，hover 13px 以顶边为轴
          对称扩展；水平方向左右各缩进一个圆角半径，避免条体压到面板圆角 */}
      <div
      ...
      >
        <div
          ...
          className={cn(
            'pointer-events-auto group/prog relative h-[2.5px] transition-all duration-200 hover:h-[13px]',
        ...
        >
          ...
          <div className="pointer-events-none absolute left-1 -top-5 hidden items-center px-0.5 text-[9px] font-bold tabular-nums text-white group-hover/prog:flex">
